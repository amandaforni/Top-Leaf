function TopTrumpCard (name, threat, cope, toxic, image) {
    this.name = name;
    this.threat = threat;
    this.cope = cope;
    this.toxic = toxic;
...
function drawP1Card() {
    ...
    //Won't work if put into jQuery format...why?
    $("#yourCard").attr(alt = player1Card.name);
    $("#P1Name").html(player1Card.name);
    $("#P1threat").html(player1Card.threat);
    $("#P1cope").html(player1Card.cope);
    $("#P1toxic").html(player1Card.toxic);
...
function drawP2Card() {
    ...
    //Won't work if put into jQuery format...why?
    $("#oppCard").attr(alt = player2Card.name);
    $("#P2Name").html(player2Card.name);
    $("#P2threat").html(player2Card.threat);
    $("#P2cope").html(player2Card.cope);
    $("#P2toxic").html(player2Card.toxic);
}
...
function changeCardValues() {
    $("#yourCards").html(yourStack);
    $("#oppCards").html(oppStack);
}
